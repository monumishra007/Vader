...
HELLPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/5dec2abf60383914e6346.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
USER_BOT_WARN_ZERO = "**You were spamming my sweet master's inbox, henceforth you have been blocked by my master's MONU USER BOT.**\n__Now GTFO, i'm busy__"
USER_BOT_NO_WARN = (
    "Hello, This is **monu userbot security 😉⚠️**.\n"
        ...
        if len(APPROVED_PMs) > 4095:
            with io.BytesIO(str.encode(APPROVED_PMs)) as out_file:
                ...
                await event.client.send_file(
                    ...
                    force_document=True,
                    allow_cache=False,
                    caption="[monuuserbotBot]Current Approved PMs",
                    reply_to=event,
                )
                await event.delete()
        else:
...
CmdHelp("pmpermit").add_command(
  "allow", "<pm use only>", "It allow the user to PM you. ❤️ @monumishra007 ❤️"
).add_command(
